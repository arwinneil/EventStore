	...
	public class Authorization : specification_with_standard_projections_runnning {
		...
		public void authorization_tests(
			...
			[Values(
				...
				"/projection/name/query?type={type}&emit={emit};PUT;Ops", /* /projection/{name}/query?type={type}&emit={emit} */
				...
				"/projection/{name}/command/disable?enableRunAs={enableRunAs};POST;Ops",
				"/projection/{name}/command/enable?enableRunAs={enableRunAs};POST;Ops",
				"/projection/{name}/command/reset?enableRunAs={enableRunAs};POST;Ops",
				"/projection/{name}/command/abort?enableRunAs={enableRunAs};POST;Ops",
